    ...
    <button
        ...
        className={classNames(
            "transition rounded py-2 text-center flex place-items-center gap-2 disabled:saturate-75 disabled:brightness-70 disabled:cursor-not-allowed",
            {
                ...
                "bg-white/[.07]": type === Type.FilledTonal && variant === undefined,
                "bg-sky-500/[.07] text-sky-500": type === Type.FilledTonal && variant === Variant.Info,
                "bg-green-600/[.07] text-green-600": type === Type.FilledTonal && variant === Variant.Success,
                "bg-amber-600/[.07] text-amber-600": type === Type.FilledTonal && variant === Variant.Warning,
                "bg-red-600/[.07] text-red-600": type === Type.FilledTonal && variant === Variant.Error,
                "px-2": type === Type.Text,
                "hover:bg-white/[.04]": type === Type.Text && variant === undefined,
                "hover:bg-sky-500/[.04] text-sky-500": type === Type.Text && variant === Variant.Info,
                "hover:bg-green-600/[.04] text-green-600": type === Type.Text && variant === Variant.Success,
                ...
                "hover:bg-red-600/[.04] border-2 border-red-600 text-red-600": type === Type.Outlined && variant === Variant.Error
            }
        )}
